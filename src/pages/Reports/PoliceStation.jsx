...
import '../../public/assets/css/PoliceStation.css';
                            ...
                            <div className="col-md-12">
                                <div className="table-card">
                                    <div className="table-card-heading">
                                        ...
                                        <button className="table-card-btn" onClick={() => alert('View All Clicked')}>View All <i className="fa-solid fa-play"></i></button>
                                    </div>
                                        ...
                                        <table className="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>12:24:04</td>
                                                    <td>Khandagiri</td>
                                                    <td><img src="/assets/images/accident-1.png" alt="Accident 1" /></td>
                                                </tr>
                                                <tr>
                                                    <td>02</td>
                                                    <td>Car Accident</td>
                                                    <td>12:24:04</td>
                                                    <td>Khandagiri</td>
                                                    <td><img src="/assets/images/accident-2.png" alt="Accident 2" /></td>
                                                </tr>
                                                <tr>
                                                    <td>03</td>
                                                    <td>Car Accident</td>
                                                    <td>12:24:04</td>
                                                    <td>Khandagiri</td>
                                                    <td><img src="/assets/images/accident-3.png" alt="Accident 3" /></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
