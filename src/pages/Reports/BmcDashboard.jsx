...
import "../../public/assets/css/Bbsreport.css";
                                        ...
                                        <nav id="navigation1" className="navigation">
                                            ...
                                            <div className="nav-menus-wrapper">
                                                <ul className="navbar-nav">
                                                    ...
                                                    <li className="nav-item">
                                                        <button type="button" className="btn-link">Author</button>
                                                    </li>
                                                    <li className="nav-item">
                                                        <button type="button" className="btn-link">Registration</button>
                                                    </li>
                                                    <li className="nav-item">
                                                        <button type="button" className="btn-link">Committees</button>
                                                    </li>
                                                    <li className="nav-item">
                                                        <button type="button" className="btn-link">Contact Us</button>
                                                    </li>
                                                </ul>
                                            </div>
                                        </nav>
                            ...
                            <div className="col-md-12">
                                <div className="table-card">
                                    <div className="table-card-heading">
                                        ...
                                        <button type="button" className="table-card-btn">
